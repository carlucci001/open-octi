---
id: "ct-candidates-2026"
name: "CT 2026 State Candidate Source Audit"
level: "state"
coverage: ["CT"]
...
tier: "D"
endpoint: "https://portal.ct.gov/sots/election-services"
request: {"format":"no-api","allowHtmlScrape":false,"allowPdf":false,"officialLandingPage":"https://portal.ct.gov/sots/election-services"}
...
compliance: {"channels":[],"dppa":false,"fcra":false,"tosReviewedAt":"2026-09-03","tosVerdict":"not enabled; exact official CSV/XLSX/JSON/API URL and commercial-use terms must be verified before promotion"}
proving: {"thresholds":{"freshness":0,"geoPrecision":0.95,"contactability":0.8},"status":"excluded-from-build"}
discovered: false
excludedReason: "no-api: official structured candidate download not yet independently verified; HTML scraping and PDF parsing are forbidden"
links: ["[[trigger/candidate-filed]]","[[jurisdiction/CT]]","[[vertical/political-campaigns]]"]
---
