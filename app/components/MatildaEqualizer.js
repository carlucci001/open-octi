    ...
    >
      ...
      <div
        style={{
          ...
          minWidth: 94,
          borderRadius: 999,
          border: active ? '1px solid rgba(239,68,68,0.85)' : speaking ? '1px solid rgba(251,146,60,0.45)' : '1px solid rgba(120,120,128,0.28)',
          background: speaking ? 'rgba(251,146,60,0.12)' : 'rgba(120,120,128,0.12)',
          boxShadow: active ? '0 0 16px rgba(239,68,68,0.55), 0 0 4px rgba(239,68,68,0.8)' : speaking ? '0 0 12px rgba(251,146,60,0.35)' : 'none',
          color: 'inherit',
          display: 'flex',
          alignItems: 'center',
          padding: 0,
