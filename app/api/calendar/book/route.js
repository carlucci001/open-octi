...
const ALLOWED_CALENDAR_KEYS = new Set(['farrington-dev', 'newsroomaios'])
...
export async function POST(request) {
  try {
    ...
    source = source || (isDemo ? 'newsroomaios_demos' : 'manual')
    calendarKey = calendarKey || (isDemo ? 'newsroomaios' : 'farrington-dev')
    ...
    if ((calendarKey === 'newsroomaios') !== Boolean(isDemo)) {
