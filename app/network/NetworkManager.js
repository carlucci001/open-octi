...
import OpenOctiNetwork from './OpenOctiNetwork'
    ...
    <div className="command-workspace p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
        ...
        <div className="rounded-xl overflow-hidden" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          ...
          <div>
            {[
              { name: 'OpenOcti CRM service', detail: stats.crmService?.workingDirectory || '/root/farrington-command-center', ok: stats.crmService?.ok && stats.local?.ok, ms: stats.local?.ms },
...
export default function NetworkManager() {
  return isOpenOcti() ? <OpenOctiNetwork /> : <CommandCenterNetwork />
}
