...
const BRANDS = {
  farrington: {
    name: BRAND_ASSETS.openOcti ? 'OpenOcti' : 'Farrington Development LLC',
    person: BRAND_ASSETS.openOcti ? null : 'Carl Farrington',
    ...
    textColor: '#1a1c2e',
    mutedColor: '#6b7084',
    altText: BRAND_ASSETS.openOcti ? 'OpenOcti' : 'Farrington Development',
    phoneHref: BRAND_ASSETS.openOcti ? '' : 'tel:PHONE_REDACTED',
    phoneDisplay: BRAND_ASSETS.openOcti ? '' : 'PHONE_REDACTED',
    email: BRAND_ASSETS.openOcti ? (process.env.OWNER_EMAIL || '') : 'personal@example.invalid',
    website: BRAND_ASSETS.openOcti ? 'openocti.com' : 'company.example.com',
    websiteUrl: BRAND_ASSETS.openOcti ? 'https://openocti.com' : 'https://company.example.com',
    location: BRAND_ASSETS.openOcti ? '' : 'City, ST',
    social: [],
  },
  newsroom: {
    name: 'ContentStudio',
    person: 'The ContentStudio Team',
    localLogos: null,
    ...
    social: [
      ...
      { label: 'X',        url: 'https://x.com/ContentStudio', icon: 'x', color: '000000' },
      { label: 'TikTok',   url: 'https://www.tiktok.com/@ContentStudio', icon: 'tiktok', color: '000000' },
      { label: 'YouTube',  url: 'https://www.youtube.com/@ContentStudio', icon: 'youtube', color: 'FF0000' },
    ],
  },
  wnctimes: {
    name: 'WNC Times',
