...
const BRANDS = {
  farrington: {
    name: BRAND_ASSETS.openOcti ? 'OpenOcti' : 'Your organization',
    person: BRAND_ASSETS.openOcti ? null : 'Workspace owner',
    ...
    textColor: '#1a1c2e',
    mutedColor: '#6b7084',
    altText: BRAND_ASSETS.openOcti ? 'OpenOcti' : 'Your organization',
