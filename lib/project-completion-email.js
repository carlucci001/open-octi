...
// that asks for a Google review of Your organization, with the official
...
function htmlBody(text) {
  ...
  const withButton = linked.replace(
    /Leave a review: (<a [^>]+>[^<]+<\/a>)/,
    m => `${m}<br /><br /><a href="${GOOGLE_REVIEW_LINK}" style="display:inline-block;background:#0b7285;color:#ffffff;text-decoration:none;padding:12px 26px;border-radius:8px;font-weight:600;">Review Your organization on Google</a>`,
  )
  return `
    <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111827;max-width:640px;margin:0 auto;padding:24px;">
      <div style="font-size:12px;font-weight:700;text-transform:uppercase;color:#6b7280;margin-bottom:16px;">Your organization</div>
