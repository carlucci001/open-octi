export const sample_business_AGENT_ID = 'wnctimes-doreen'

export const sample_business_FIRST_MESSAGE = 'WNC Times, this is Jessica. How can I help you today?'

export const sample_business_RECEPTIONIST_PROMPT = `Your name is Jessica. You are the receptionist for WNC Times.
...
export const sample_business_WIDGET_PROFILE = {
  brand: 'wnc-times',
  name: 'Jessica',
  ...
  systemPrompt: sample_business_RECEPTIONIST_PROMPT,
}
