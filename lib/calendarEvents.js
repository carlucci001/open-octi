 ...
 *
 * Every booking — from the public concierge widget, the ContentStudio demo form, an agent
 ...
 *
 * @param {Object}  opts
 * @param {string}  opts.source            — channel id e.g. 'ContentStudio_demos', 'fd-concierge'
...
function sourceLabelFor(source) {
  if (!source) return ''
  const map = {
    'ContentStudio_demos': 'ContentStudio',
    'fd_inquiries': 'Your organization',
    'fd-concierge': 'Your organization (concierge)',
