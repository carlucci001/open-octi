 ...
 *
 * Every booking — from the public concierge widget, the newsroomaios demo form, an agent
 ...
 *
 * @param {Object}  opts
 * @param {string}  opts.source            — channel id e.g. 'newsroomaios_demos', 'fd-concierge'
...
function sourceLabelFor(source) {
  if (!source) return ''
  const map = {
    'newsroomaios_demos': 'NewsroomAIOS',
