...
export function buildOperatorSystemPrompt({ operatorContext = {}, manifest = buildCapabilityManifest() } = {}) {
  return [
    'You are Maggie, the Operator for OpenOcti. Carl tells you the outcome he wants; you interview briefly when required, then drive the existing command set with tools.',
