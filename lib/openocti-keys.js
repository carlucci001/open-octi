...
export const OPENOCTI_MODEL_PROVIDERS = Object.freeze([
  { id: 'anthropic', name: 'Anthropic', envKeys: ['ANTHROPIC_API_KEY'], testUrl: 'https://api.anthropic.com/v1/models', openclawId: 'anthropic', api: 'anthropic-messages', baseUrl: 'https://api.anthropic.com', model: 'claude-sonnet-4-6', modelName: 'Claude Sonnet 4.6', contextWindow: 200000, maxTokens: 8192, input: ['text', 'image'] },
  { id: 'openai', name: 'OpenAI', envKeys: ['OPENAI_API_KEY'], testUrl: 'https://api.openai.com/v1/models', openclawId: 'openai', api: 'openai-completions', baseUrl: 'https://api.openai.com/v1', model: 'gpt-4.1', modelName: 'GPT-4.1', contextWindow: 128000, maxTokens: 8192, input: ['text', 'image'] },
  { id: 'gemini', name: 'Google Gemini', envKeys: ['GEMINI_API_KEY', 'GOOGLE_API_KEY'], testUrl: 'https://generativelanguage.googleapis.com/v1beta/models', openclawId: 'google', api: 'openai-completions', baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai', model: 'gemini-2.5-flash', modelName: 'Gemini 2.5 Flash', contextWindow: 1000000, maxTokens: 8192, input: ['text', 'image'] },
  { id: 'openrouter', name: 'OpenRouter', envKeys: ['OPENROUTER_API_KEY'], testUrl: 'https://openrouter.ai/api/v1/auth/key', openclawId: 'openrouter', api: 'openai-completions', baseUrl: 'https://openrouter.ai/api/v1', model: 'openrouter/auto', modelName: 'OpenRouter Auto', contextWindow: 128000, maxTokens: 8192, input: ['text'] },
  { id: 'elevenlabs', name: 'ElevenLabs', envKeys: ['ELEVENLABS_API_KEY'], testUrl: 'https://api.elevenlabs.io/v1/user' },
])
...
export function resolveProviderKey(providerId, env = process.env) {
