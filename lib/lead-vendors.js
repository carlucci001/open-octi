...
// "Asheville, NC" / "Asheville, North Carolina" / "Asheville" -> parts.
...
//   companyState "North Carolina" + city "Asheville" -> 0 in NC
//   companyState "NC" alone, no postal codes         -> 0 in NC
//   companyCityPostalCode ["28801","28803",...]      -> 20/20 in Asheville
...
export function resolveLeadVendorConfig(overrides = {}) {
  ...
  return {
    ...
    // Verified 2026-08-06: a run scoped to Asheville, North Carolina returned
...
const FREEMAIL = /@(gmail|hotmail|yahoo|aol|outlook|icloud|live|msn)\./i
