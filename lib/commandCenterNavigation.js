...
const ALL_COMMAND_CENTER_SECTIONS = [
  ...
  },
  {
    id: 'platforms',
    label: 'Platforms',
    // SearchSuite3's old aliases migrate here so voice/nav keeps working — they
    // land on Platforms, where SearchSuite3 is the first platform in the list.
    aliases: ['platforms', 'platform', 'platform manager', 'platform list', 'managed platforms', 'platform control', 'SearchSuite3', 'get found 3', 'get found three', 'visibility reports', 'seo reports', 'aeo reports', 'geo reports', 'website visibility', 'remediation reports'],
  },
  {
    id: 'contacts',
    label: 'Contacts',
