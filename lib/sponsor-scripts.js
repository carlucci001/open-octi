    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I run a community news platform called ContentHub, and I'm reaching out because what we're building directly aligns with what [ORG NAME] does for [MARKET]. Do you have two minutes?",
        ],
      },
      {
...
export const NEWSPAPER_SCRIPTS = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          "I built a platform called ContentHub. It gives community newspapers the same AI-powered tools that the big media companies use — but it's built specifically for papers like [THEIR PAPER].",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I run ContentHub — we're an AI platform for community newspapers. I'm calling because I've got a way for [THEIR PAPER] to add $15,000 to $17,000 in annual revenue. Got 90 seconds?",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I've been in web development for 30 years and I run a community news platform called ContentHub. I've been following [THEIR PAPER] and I'm impressed with what you've built in [CITY]. Do you have a few minutes?",
        ],
      },
      {
...
export const TDA_SCRIPTS = [
  {
    ...
    tag: "G",
    description: "Position ContentHub as a tourism amplifier. State TDAs need digital reach — show them how a network of local news sites drives organic tourism coverage they can't get from traditional media buys.",
    sections: [
      {
        heading: "Opening (professional, government-appropriate tone)",
        lines: [
          "Hi, this is Carl Farrington with ContentHub. I'm reaching out to your tourism office — who handles digital partnerships or media relations for tourism promotion?",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I run ContentHub — a network of local news platforms across 17 US markets. I'm calling about a tourism content distribution opportunity for [STATE]. Who handles your digital strategy or media buying?",
        ],
      },
      {
