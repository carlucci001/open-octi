    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Workspace owner. I run a community news platform called ContentStudio, and I'm reaching out because what we're building directly aligns with what [ORG NAME] does for [MARKET]. Do you have two minutes?",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Workspace owner. I run a community news platform, and I've been looking at newspapers in [STATE]. I found [THEIR PAPER] and wanted to reach out — do you have a couple minutes?",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Workspace owner. I run ContentStudio — we're an AI platform for community newspapers. I'm calling because I've got a way for [THEIR PAPER] to add $15,000 to $17,000 in annual revenue. Got 90 seconds?",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Workspace owner. I've been in web development for 30 years and I run a community news platform called ContentStudio. I've been following [THEIR PAPER] and I'm impressed with what you've built in [CITY]. Do you have a few minutes?",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Workspace owner with ContentStudio. I'm reaching out to your tourism office — who handles digital partnerships or media relations for tourism promotion?",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Workspace owner. I run ContentStudio — a network of local news platforms across 17 US markets. I'm calling about a tourism content distribution opportunity for [STATE]. Who handles your digital strategy or media buying?",
        ],
      },
      {
...
export const DEV_SCRIPTS = [
  {
    ...
    tag: "A",
    description: "Cold outbound to small/medium local businesses. Leads with a specific observation about their current web presence, positions Your organization as the local AI-native alternative to agencies and freelancers.",
    sections: [
      {
        heading: "Opening (quick, specific, not a pitch)",
        lines: [
          "Hi, this is Workspace owner with Your organization here in City, ST — is this [FIRST NAME]?",
    ...
    sections: [
      {
        heading: "Opening",
        lines: [
          "Hey [FIRST NAME], Workspace owner — you reached out about [PROJECT TYPE]. Thanks for that. Got a few minutes to talk through it?",
...
export const CAMPAIGN_SCRIPTS = [
  {
    ...
    sections: [
      { heading: 'Opening', lines: [
        'Hi, this is Workspace owner with Your organization. May I speak with the campaign manager or treasurer?',
