...
export const DEFAULT_SCRIPTS = [
  {
    ...
    objections: [
      ...
      },
      {
        ...
        response: "Great question. We're launching with aggressive local SEO, Google News indexing, and social distribution built in from day one — these are the same tools the big publishers use. Our flagship paper, WNC Times in Asheville, is already proving the model. But here's the real answer: as a Founding Sponsor, you're not buying impressions — you're buying ownership of a category before anyone else can. The audience grows, your visibility grows with it, and your rate stays locked.",
      },
      {
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I run a community news platform called NewsroomAIOS, and I'm reaching out because what we're building directly aligns with what [ORG NAME] does for [MARKET]. Do you have two minutes?",
        ],
      },
      {
...
export const NEWSPAPER_SCRIPTS = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          "I built a platform called NewsroomAIOS. It gives community newspapers the same AI-powered tools that the big media companies use — but it's built specifically for papers like [THEIR PAPER].",
          ...
          "Our flagship paper, WNC Times in Asheville, is already live and proving the model. I can send you the link so you can see exactly what your paper would look like.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I run NewsroomAIOS — we're an AI platform for community newspapers. I'm calling because I've got a way for [THEIR PAPER] to add $15,000 to $17,000 in annual revenue. Got 90 seconds?",
  ...
  },
  {
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I've been in web development for 30 years and I run a community news platform called NewsroomAIOS. I've been following [THEIR PAPER] and I'm impressed with what you've built in [CITY]. Do you have a few minutes?",
        ],
      },
      {
      ...
      },
      {
        ...
        lines: [
          ...
          "We already have papers operating in Asheville, Atlanta, Seattle, and a dozen other markets. We're looking for the right partner in [CITY/STATE], and [THEIR PAPER] is exactly the kind of operation we want in the network.",
        ],
      },
      {
    ...
    objections: [
      ...
      },
      {
        ...
        response: "We're operating in 17 markets right now, with papers in Asheville, Atlanta, Chicago, Miami, Seattle, and more. Some are run by local operators, some we run ourselves to prove the model. We're actively expanding and [CITY/STATE] is a market we're focused on. That's why I'm calling you — I'd rather partner with an established paper than start from scratch.",
      },
    ],
    active: true,
    stats: { calls: 0, interested: 0, closed: 0 },
...
export const TDA_SCRIPTS = [
  {
    ...
    tag: "G",
    description: "Position NewsroomAIOS as a tourism amplifier. State TDAs need digital reach — show them how a network of local news sites drives organic tourism coverage they can't get from traditional media buys.",
    sections: [
      {
        heading: "Opening (professional, government-appropriate tone)",
        lines: [
          "Hi, this is Carl Farrington with NewsroomAIOS. I'm reaching out to your tourism office — who handles digital partnerships or media relations for tourism promotion?",
      ...
      },
      {
        ...
        lines: [
          ...
          "Our flagship, WNC Times in Asheville, is already doing this organically with Buncombe County TDA content. I'd love to scale that to the state level.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington. I run NewsroomAIOS — a network of local news platforms across 17 US markets. I'm calling about a tourism content distribution opportunity for [STATE]. Who handles your digital strategy or media buying?",
        ],
      },
      {
        heading: "Hook (numbers first — government people love data)",
        lines: [
          "Quick context: our newspaper network reaches readers across markets from Asheville to Seattle, all indexed on Google News. We're seeing strong organic engagement on tourism and events content — and we want to formalize that with state tourism offices.",
    ...
    sections: [
      {
        ...
        lines: [
          "Hi, this is Carl Farrington with Farrington Development here in Asheville — is this [FIRST NAME]?",
