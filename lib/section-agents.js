...
export const SECTION_AGENTS = {
  ...
  products: {
    label: 'Products', agentId: 'ContentStudio-promoter', name: 'Mark', role: 'Product Promoter', avatarKey: 'promoter',
  ...
  'campaign-studio': {
    label: 'Campaign Studio', agentId: 'ContentStudio-promoter', name: 'Mark', role: 'Campaign Strategist', avatarKey: 'promoter',
