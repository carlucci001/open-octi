...
export const OPENAI_REALTIME_VOICES = ['alloy', 'ash', 'ballad', 'cedar', 'coral', 'echo', 'marin', 'sage', 'shimmer', 'verse']
...
export const OPENAI_REALTIME_TOOLS = [
  ...
  },
  {
    ...
    description: 'Immediately transfer the active voice session to another named OpenOcti agent. Every active agent, including Maggie, can use this. Use this when Carl asks for Craig, Maggie, Frank, Sasha, Linda, Cameron, Mark, Doreen, Diane, or another teammate. Do not say you are checking availability.',
    parameters: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    parameters: {
      type: 'object',
      properties: {
        vault: { type: 'string', description: 'Optional vault id or name, such as command-center, ContentStudio, dark-design, wnct-template, or openclaw-workspace.' },
