...
export function notifyCapabilitiesChanged() {
  ...
  if (typeof window !== 'undefined') window.dispatchEvent(new Event('openocti-capabilities-changed'))
}
...
export function useCapabilities() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('openocti-capabilities-changed', refresh)
  }, [refresh])
