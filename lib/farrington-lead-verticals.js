export const FARRINGTON_LEAD_VERTICALS = [
  {
    ...
    description: 'Newly formed LLCs/corporations and newly licensed or permitted businesses — need a website, SEO, and AI setup.',
    serviceLine: 'web-development',
    offer: 'Website, SEO, and AI setup',
    caveat: 'Official formation and permit records; contact availability varies by state.',
    leadWith: 'Website, SEO, and AI setup for a newly opened business.',
    query: '{location} newly formed or licensed businesses',
  },
  {
    id: 'home-services',
    rank: 1,
...
export function getFarringtonLeadVertical(verticalId = 'home-services') {
  ...
  return {
    ...
    caveat: 'Custom Your organization cold-call category.',
