...
import { runOutreach } from './outreach-runner'
...
export function getAutomationRunner(automation) {
  if (matchesRunner(automation, 'outreach-sequence-v1')) return { id: 'outreach-sequence-v1', label: 'New business outreach', run: runOutreach }
  const pressRunners = {
