...
export function resolveLeadListForDestination({ leadLists = [], requestedId = '', destination = '' } = {}) {
  ...
  if (requested && leadListBelongsToDestination(requested, destination)) return requested
