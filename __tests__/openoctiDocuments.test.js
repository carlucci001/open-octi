...
describe('OpenOcti Linda documents and e-signature', () => {
  ...
  it('provides the first-run business and owner prompt on the dashboard', () => {
    ...
    expect(firstRun).toContain('Name your workspace')
    expect(firstRun).toContain('Add a model key')
    expect(firstRun).toContain('Meet your agents')
    expect(firstRun).toContain('Import your data')
    expect(firstRun).toContain("action: 'visit-agents'")
    expect(firstRun).toContain("action: 'open-import'")
